	...
	protected Set<BeanDefinitionHolder> doScan(String... basePackages) {
		...
		for (String basePackage : basePackages) {
			...
			for (BeanDefinition candidate : candidates) {
				...
				//这里的candidate是属于ScannedGenericBeanDefinition的
				//ScannedGenericBeanDefinition又是继承自AbstractBeanDefinition
				//AbstractBeanDefinition是ScannedGenericBeanDefinition的超级父类
				//所以会进入if
				...
				if (checkCandidate(beanName, candidate)) {
					...
					//将扫描出来的bd和beanname放入工厂的map和list中去
					//真正的注册方法
					//传入的是bd和beanname的封装对象bdh
